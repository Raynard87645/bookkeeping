...
@section('content')
  ...
  <div class="row">
       <div class="col-md-10 col-md-offset-1" >
         ...
         <button class="btn btn-info">Next Page</button></a>
			  <a onclick="plusSlides(1)">
			  <button class="btn btn-info pull-right">Prev Page</button></a><br></br>
 	   </div>		  
       <div class="col-md-10 col-md-offset-1" > 
       
   	  	   <form action="/employees/{{ $employees->id }}" id="selectMenu" method="POST">
               ...
               <div class="panel panel-primary" >
                 <div class="panel-heading">Other Information</div>
		   	  	  ...
		   	  	  <div class="col-md-8 col-md-offset-2" >
		   	  		  <div class="form-group">
		   	  		       <label class="col-md-12 noformpacing">Effective Date<span style="color: red"> * </span></label> 
		   	  		        <div class="col-md-6 noformpacing">
			   	  		      <input type="date" name="effective_date" class="form-control" value="{{ $employees->effective_date }}"  /><br>
			   	  		    </div>

                           <div class="col-md-12 noformpacing">
                            <label >Vacation Policy Type<span style="color: red"> * </span></label>
                               <select class="form-control" name="vacation_type" form="selectMenu" value="{{ $employees->vacation_type }}">
						  ...
						  <div class="col-md-12 noformpacing">
	                        <label >Vacation Balance<span style="color: red"> * </span></label>
			   	  		     <input type="dollar" name="vacation_balance" class="form-control" value="{{ $employees->vacation_balance }}" />
                          </div>
                          <div class="col-md-12 noformpacing">
	                        <label >Vacation Rate</label>
			   	  		     <input type="text" name="vacation_rate" class="form-control" value="{{ $employees->vacation_rate }}" />
                          </div>
                          <div class="col-md-12 noformpacing">
	                        <label >Vacation Date</label>
			   	  		     <input type="date" name="vacation_date" class="form-control" value="{{ $employees->vacation_date }}" />
                          </div>
